...
public class RecipeTypeInit {
    ...
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(ForgeRegistries.RECIPE_TYPES, ProjectM.MOD_ID);

    public static final RegistryObject<RecipeType<DryingRackRecipe>> DRYING_RACK_PROCESS =
            RECIPE_TYPES.register("drying_rack_process", () -> DryingRackRecipe.Type.INSTANCE);
