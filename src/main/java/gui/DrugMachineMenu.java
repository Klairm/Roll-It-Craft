...
public class DrugMachineMenu extends AbstractContainerMenu {
	public final DrugMachineEntity blockEntity;
	private final Level level;
	private final ContainerData data;

	public DrugMachineMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
